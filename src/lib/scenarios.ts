...
export const cushionScenarios: Scenario[] = [
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: POOL_TABLE.width - BALL_R - 50, y: 635, vx: 1000, vy: 0 }],
    physics: 'pool',
    duration: 5,
  },
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: 1270, y: POOL_TABLE.height - BALL_R - 50, vx: 0, vy: 1000 }],
    physics: 'pool',
    duration: 5,
  },
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: POOL_TABLE.width - BALL_R - 100, y: 635, vx: 1000, vy: 1000 }],
    physics: 'pool',
    duration: 5,
  },
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: POOL_TABLE.width - BALL_R - 50, y: 635, vx: 1000, vy: 0, spin: [0, 0, 30] }],
    physics: 'pool',
    duration: 5,
  },
  {
  ...
  },
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: POOL_TABLE.width - BALL_R - 50, y: 635, vx: 2000, vy: 0 }],
    physics: 'pool',
    duration: 10,
  },
  {
    ...
    balls: [
      {
        id: 'ball',
        x: POOL_TABLE.width - BALL_R - 30,
        y: POOL_TABLE.height - BALL_R - 30,
        vx: 1000,
        vy: 1000,
      },
    ],
  ...
  },
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: POOL_TABLE.width - BALL_R - 5, y: 400, vx: 50, vy: 1000 }],
    physics: 'pool',
    duration: 5,
  },
  {
  ...
  },
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: 1270, y: BALL_R + 50, vx: 0, vy: -1000 }],
    physics: 'pool',
    duration: 5,
  },
  {
    ...
    table: POOL_TABLE,
    balls: [{ id: 'ball', x: BALL_R + 50, y: 635, vx: -1000, vy: 0 }],
    physics: 'pool',
    duration: 5,
  },
  {
